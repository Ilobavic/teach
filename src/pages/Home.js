  ...
  return (
    <>
      <div className="hero mb-4 animate__animated animate__fadeIn">
        ...
        <p className="mb-0">Welcome to the Campus Portal</p>
      </div>
      <Row>
        <Col md={6} className="mb-3">
          <Card className="card-hover">
            <Card.Body>
              ...
              <Card.Text>Access your dashboard and view notes shared by lecturers.</Card.Text>
        ...
        <Col md={6} className="mb-3">
          <Card className="card-hover">
            <Card.Body>
              ...
              <Card.Text>Upload notes and manage classes.</Card.Text>
